  ...
  return (
    <article className="group w-full overflow-hidden rounded-[30px] border border-border bg-card shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
      ...
      <div className="relative h-72 overflow-hidden">
        ...
        {/* FAVORITE BUTTON */}
        <button className="absolute left-4 top-4 z-10 flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-white/80 text-maroon backdrop-blur-md transition-all duration-300 hover:scale-110 dark:bg-black/30 dark:text-primary">
