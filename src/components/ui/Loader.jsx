/**
 * Pawly themed loader component.
 * Sizes:
 *  - "page"    : full-viewport centered overlay (for Next.js loading.js files)
 *  - "section" : centered inside a container (min-h: 300px)
...
export function Loader({ size = "section", label = "Loading..." }) {
  if (size === "inline") {
    return (
