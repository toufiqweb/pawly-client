        ...
        <div className="bg-card/70 backdrop-blur-md border border-border/80 shadow-xl shadow-foreground/5 rounded-3xl p-5 md:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="h-14 px-8 font-semibold rounded-2xl bg-primary text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/95 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                {/* Updated from VenusMars to VenusAndMars */}
          ...
          <div className="flex items-center justify-between border-t border-border/60 pt-4 mt-2">
            ...
            <button
              ...
              className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-destructive hover:text-destructive/80 transition-colors ml-auto sm:ml-0 group py-1"
            >
