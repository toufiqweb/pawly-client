...
const PetDetailPageContent = ({ pet }) => {
  const {
    petName,
    species,
    breed,
  ...
  return (
    <div className="lg:col-span-8 space-y-6">
      {/* HERO IMAGE */}
      <div className="relative overflow-hidden rounded-[28px] bg-[#d9cfe3] h-80 md:h-130 border border-border">
        <div className="absolute top-4 left-4 z-10">
          <span className="flex items-center gap-1 bg-primary/15 text-primary text-xs font-semibold px-3 py-1 rounded-full">
        ...
        <div className="bg-card rounded-[24px] border border-border p-6 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <button className="mt-2 flex items-center gap-1 text-sm text-primary font-semibold hover:underline">
                View Profile
