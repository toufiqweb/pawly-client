    ...
    <section className="w-full py-16 md:py-24 px-4 bg-background text-foreground">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 mb-12">
          ...
          {/* Button */}
          <button className="group flex items-center gap-3 bg-card text-primary hover:opacity-90 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 shadow-md hover:shadow-xl active:scale-95">
