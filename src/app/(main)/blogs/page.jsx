...
// Server-side safe Mock Data (Could be fetched from an API/Database instead)
const categories = [
  "All",
  "Success Stories",
  "Pet Care",
...
const BlogsPage = () => {
  // Hardcoded default active category for server template since states aren't used
          ...
          <div className="bg-card rounded-3xl overflow-hidden border border-border shadow-lg grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 p-6 sm:p-8 lg:p-10 flex flex-col justify-between bg-card">
              ...
              <div className="mt-6 pt-6 border-t border-border flex items-center justify-between">
                ...
                <button className="flex items-center gap-1 text-primary font-bold text-sm hover:underline transition-all group">
                  Read Story
                  <ArrowRight
                    size={16}
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 mb-10 border-b border-border">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl border border-border bg-input text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-8">
              ...
              {blogPosts.map((post) => (
                ...
                >
                  ...
                  <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <div className="pt-4 border-t border-border flex items-center text-sm font-bold text-primary group-hover:underline transition-colors">
            ...
            <div className="clear-both mt-12 text-center">
              <button className="bg-card border border-border text-foreground px-6 py-3 rounded-xl font-semibold text-sm hover:bg-secondary transition-colors inline-flex items-center gap-2 shadow-sm">
                Load Older Articles
              </button>
            </div>
          </div>
          ...
          <aside className="lg:col-span-4 lg:sticky lg:top-24 h-fit space-y-6">
            ...
            <div className="bg-secondary rounded-3xl p-6 border border-border shadow-md relative overflow-hidden group">
              ...
              <div className="relative space-y-5">
                ...
                <button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-3 rounded-xl text-sm transition-all shadow-md flex items-center justify-center gap-2">
            ...
            <div className="bg-card rounded-3xl p-6 border border-border shadow-sm space-y-4">
              ...
              <div className="space-y-2">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-border bg-input text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                />
                <button className="w-full bg-foreground text-background font-bold py-3 rounded-xl text-sm hover:opacity-90 transition-opacity shadow-sm">
                  Subscribe
                </button>
              </div>
